...
- An authentication token with `REPO_READ` permission, loaded from a file named `apikey` located within the skill directory (`.junie/skills/bitbucket-review/apikey`).
